...
<body>
<div class="weather34darkbrowser" url="Almanac Wind Speed <?php echo "(".$weather["wind_units"].")";?> Data | <?php echo $stationlocation?> "></div> 
...
</span> <div class="higust">Max Wind Speed <br>Recorded <span><?php echo $weather["windydmaxtime"];?></span></div>
<br>
