...
.weather34card{width:500px;height:17.5rem;background-color:#none;border-radius:4px;position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;color:#aaa;font-size:11px;font-weight:normal;padding:15px;border:solid #444 1px;margin:2px}
...
<body>
<div class="weather34darkbrowser" url="Almanac Rainfall (<?php echo $weather["rain_units"]?>) Data | <?php echo $stationlocation;?>"></div> 
