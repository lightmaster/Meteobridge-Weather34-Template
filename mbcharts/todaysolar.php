<?php
	...
	include('conversion.php');include('./chart_theme.php');header('Content-type: text/html; charset=utf-8');
    echo '
...
<body>
<div class="weather34darkbrowser" url="<?php echo $stationlocation;?> Solar Radiation Recorded (Wm/2) <?php echo date('D F jS Y') ;?>"></div>
